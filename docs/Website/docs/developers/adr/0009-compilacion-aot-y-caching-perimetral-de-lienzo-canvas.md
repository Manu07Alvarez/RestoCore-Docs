---
id: 0009-compilacion-aot-y-caching-perimetral-de-lienzo-canvas
title: ADR-0009 Compilación AOT y Caché Perimetral en CDN para Canvas
---

# ADR-0009: Compilación Ahead-Of-Time (AOT) y Caché Perimetral en CDN para el Lienzo de Menú (Canvas)
